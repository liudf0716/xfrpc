...
*/
static int compress2(unsigned char *dest, size_t *destLen, const unsigned char *source,
...
*/
static int  uncompress2(unsigned char *dest, size_t *destLen, const unsigned char *source, size_t *sourceLen) {
    z_stream stream;
    int err;
    const unsigned int max = (unsigned int)-1;
    size_t len, left;
